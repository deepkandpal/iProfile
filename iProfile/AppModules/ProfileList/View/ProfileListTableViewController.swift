...
class ProfileListTableViewController: UITableViewController {
  ...
  var profileArrayList:Array<ProfileModel> = Array()
  
  override func viewDidLoad() {
    super.viewDidLoad()
    
    self.title = "Profile-List"
    presentor?.startFetchingProfileData()    
...
extension ProfileListTableViewController:PresenterToViewProtocol{
  
  func showProfileData(modelArray profileArray: Array<ProfileModel>) {
